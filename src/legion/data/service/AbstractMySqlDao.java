...
//			qstr += " where " + COL_UID + "='" + _obj.getUid() + "'";
	...
	protected static String packMasterQueryField(String _targetMasterField, String _masterTable, String _masterKey, String _detailTable, String _detailMasterKey) {
		StringBuilder sb = new StringBuilder();
		sb.append("(");
	...
	protected static String packDetailQueryField(String _targetDetailField, String _masterTable,String _masterKey,String _detailTable, String _detailMasterKey) {
	...
	protected static String packDetailQueryField(String _targetDetailField, String _masterTable, String _masterKey,
		...
		StringBuilder sb = new StringBuilder();
		sb.append("(");
		sb.append("select group_concat( distinct( ").append(_targetDetailField).append(" )) from ").append(_detailTable);
	...
	protected static String packConjQueryField(String _targetField2, String _table1, String _table2, String _conjTable, String _conjUid1, String _conjUid2) {
		return packConjQueryField( _targetField2,  _table1,  _table2,  _conjTable,  _conjUid1,  _conjUid2, null);
	}
	
	protected static String packConjQueryField(String _targetField2, String _table1, String _table2, String _conjTable, String _conjUid1, String _conjUid2
			, Map<String, String> _conjFixConditionMap) {
		StringBuilder sb = new StringBuilder();
		sb.append("(");
		...
		sb.append("select ").append(_conjUid2).append(" from ").append(_conjTable).append(" where ").append(_conjUid1).append(" = ").append(_table1).append(".").append(COL_UID);
		/* ConjFixConditionMap */
	...
	private static <Q extends QueryParam, T> String combineQueryValue(Function<Q, String> _queryParamMappingParser, QueryValue<Q, T>[] _qvs, ConjunctiveOp _qvsConjunctiveOp) {
		Function<QueryValue<Q, ?>, String> sqlParser = t->{
			...
			if(v==null)
				...
				if(v.getClass() == String.class) {
					// TODO sqlSb.append("'").append( XssUtil.stripSqlInjection( (String)v)).append("'"); 
...
//				sb.append(" and ");
	...
	protected static <Q extends QueryParam, T, P extends QueryParam> String packExistsField(String _tb1, String _keyCol1, String _tb2, String _keyCol2
			, Function<Q, String> _queryParamMappingParser, Map<P, QueryValue[]> _inSelectQueryValueMap, P _p) {
		return packExistsField(_tb1, _keyCol1, _tb2, _keyCol2, _queryParamMappingParser, _inSelectQueryValueMap, ConjunctiveOp.and, _p);
	}
	
	protected static <Q extends QueryParam, T, P extends QueryParam> String packExistsField(String _tb1, String _keyCol1, String _tb2, String _keyCol2
			, Function<Q, String> _queryParamMappingParser, Map<P, QueryValue[]> _inSelectQueryValueMap,
			ConjunctiveOp _qvsConjunctiveOp,
			P _p) {
		String conditionSql = "";
		if(_inSelectQueryValueMap!=null) {
			QueryValue[] _queryValues = _inSelectQueryValueMap.get(_p);
			conditionSql = _queryValues==null?"":combineQueryValue(_queryParamMappingParser, _queryValues, _qvsConjunctiveOp);
		}
	...
	protected static <Q extends QueryParam, T, P extends QueryParam> String packExistsField(String _tb1, String _keyCol1, String _tb2, String _keyCol2
		...
		return packExistsField( _tb1,  _keyCol1,  _tb2,  _keyCol2
				,  _conditionSql, true);
	}
	
	protected static <Q extends QueryParam, T, P extends QueryParam> String packExistsField(String _tb1, String _keyCol1, String _tb2, String _keyCol2
			, String _conditionSql, boolean _equalTrue) {
		StringBuilder sb = new StringBuilder();
